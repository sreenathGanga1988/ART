...
{
    public partial class DORTransaction : System.Web.UI.Page
    {
        ...
        public void FillFabriDOcombo(int atcid)
        {
            ...
            ddl_do.DataSource = BLL.InventoryBLL.RollTransactionBLL.getFabricDORDetails(atcid, lctnpk);

            ddl_do.DataValueField = "DOR_PK";
            ddl_do.DataTextField = "DORNum";
            ddl_do.DataBind();
            upd_do.Update();
        ...
        public void FillFabricombo(int do_pk)
        {
            ...
            drp_color.DataSource = BLL.InventoryBLL.RollTransactionBLL.getFabricDetailsInsideDOR(do_pk);
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            tbl_inventory.DataSource = fbrolldet.getNonDeliveredRollofaIteminOneLocatiomagainstADOR(int.Parse(drp_color.SelectedValue.ToString()), int.Parse(Session["UserLoc_pk"].ToString().Trim()), int.Parse(ddl_do.SelectedValue.ToString()));
