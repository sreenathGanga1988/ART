...
{
    public partial class RORollEntry : System.Web.UI.Page
    {
        ...
        public void FillFabricROincombo(int atcid)
        {
            ...
            ddl_ro.DataSource = BLL.InventoryBLL.RollTransactionBLL.getFabricROIN(atcid, lctnpk);

            ddl_ro.DataValueField = "ROIN_PK";
            ddl_ro.DataTextField = "ROInNum";
            ddl_ro.DataBind();
            upd_do.Update();
        ...
        public void FillFabricombo(int do_pk)
        {
            ...
            drp_color.DataSource = BLL.InventoryBLL.RollTransactionBLL.getFabricDetailsInsideROin(do_pk);
