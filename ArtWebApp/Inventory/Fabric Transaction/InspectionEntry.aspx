<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="InspectionEntry.aspx.cs" Inherits="ArtWebApp.Inventory.Fabric_Transaction.InspectionEntry" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">


    
 <script type="text/javascript" src="../../JQuery/GridJQuery.js"> 
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="auto-style7">
                                    <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                        <ContentTemplate>
                                            <asp:Button ID="btn_yardage" Font-Bold="True" Font-Size="X-Small" Text="Copy Supplier Shade" Width="150px" runat="server" Height="22px" OnClick="btn_yardage_Click"  />
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                                <td colspan="2" class="auto-style7">
