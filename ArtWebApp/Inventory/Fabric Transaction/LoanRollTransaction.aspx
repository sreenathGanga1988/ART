<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="LoanRollTransaction.aspx.cs" Inherits="ArtWebApp.Inventory.Fabric_Transaction.LoanRollTransaction" %>
                ...
                <tr>
                    ...
                    <td class="auto-style9" >
                      ...
                      <asp:UpdatePanel ID="upd_do" UpdateMode="Conditional" runat="server">
                                                <ContentTemplate>
                                                <ucc:DropDownListChosen ID="ddl_loan" runat="server" Height="25px" Width="170px" DisableSearchThreshold="10">
                        </ucc:DropDownListChosen>
                                                   </ContentTemplate>
                                            </asp:UpdatePanel>
                    <td >
