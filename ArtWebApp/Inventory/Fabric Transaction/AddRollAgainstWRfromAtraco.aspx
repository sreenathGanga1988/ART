<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="AddRollAgainstWRfromAtraco.aspx.cs" Inherits="ArtWebApp.Inventory.Fabric_Transaction.AddRollAgainstWRfromAtraco" %>
...
<table class="DataEntryTable">
                <tr>
                    <td class="RedHeadding" colspan="5">
                        &nbsp;&nbsp;&nbsp;&nbsp; WR(from Atraco) ROlls Details</td>
                </tr>
                <tr>
                    <td">
                                ...
                                <asp:GridView ID="tbl_InverntoryDetails" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" style="font-size: small; font-family: Calibri; font-weight: 400;" Width="100%" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" ShowFooter="True">
                                    <Columns>
                                         ...
                                         <asp:TemplateField HeaderText="UOM">
                                          ...
                                          <asp:TemplateField HeaderText="Width">
                                           ...
                                           <asp:TemplateField HeaderText="GSM">
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="txt_sgsm" CssClass="txt_gms1" onkeyup="enter(this)" runat="server" Width="70px"  Text='0'></asp:TextBox>
                                            </ItemTemplate>
                                                <HeaderStyle Width="70px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Weight">
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="txt_sweight" CssClass="txt_weight1"  onkeyup="enter(this)" runat="server" Width="70px"  Text='0'></asp:TextBox>
                                            </ItemTemplate>
                                                <HeaderStyle Width="70px" />
