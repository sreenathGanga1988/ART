<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="DeliveryOrderEndbit.aspx.cs" Inherits="ArtWebApp.Inventory.DeliveryOrder.DeliveryOrderEndbit" %>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="tbl_InverntoryDetails" CssClass="dataentry" ShowFooter="True" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" style="font-size: small; font-family: Calibri; font-weight: 400;" Width="100%" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="LaySheetDet_PK">
                                            <ItemTemplate>
                                                <asp:Label ID="lblLaySheetDet_PK" runat="server" Text='<%# Bind("LaySheetDet_PK") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Endbit">
                                            <ItemTemplate>
                                                <asp:Label ID="lblEndbit" runat="server" Text='<%# Bind("Endbit") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>                                        
