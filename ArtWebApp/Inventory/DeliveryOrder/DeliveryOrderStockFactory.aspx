<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="DeliveryOrderStockFactory.aspx.cs" Inherits="ArtWebApp.Inventory.DeliveryOrder.DeliveryOrderStockFactory" %>
...
<table class="DataEntryTable">
                ...
                <tr>
                    ...
                    <td class="NormalTD">
                        ...
                        <ucc:dropdownlistchosen ID="drp_fromWarehouse" runat="server"  Width="200px"  DataTextField="name" DataValueField="pk" DisableSearchThreshold="10">
                ...
                <tr>
                    ...
                    <td >
                          ...
                          <ucc:dropdownlistchosen ID="drp_ToWarehouse" runat="server"  Width="200px"  DataTextField="name" DataValueField="pk" DisableSearchThreshold="10">
                             </ucc:dropdownlistchosen>           
                    </td>
                    <td >
                        BOE No</td>
                    ...
                    <td >
                        Mode:</td>
                    <td >
                         <ucc:DropDownListChosen ID="drp_deliverymode"  DataTextField="name" DataValueField="pk" runat="server" Width="200px">
                        </ucc:DropDownListChosen>
                    </td>
                </tr>
                <tr>
