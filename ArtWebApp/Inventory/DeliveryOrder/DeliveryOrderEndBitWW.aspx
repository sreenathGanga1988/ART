<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="DeliveryOrderEndBitWW.aspx.cs" Inherits="ArtWebApp.Inventory.DeliveryOrder.DeliveryOrderEndBitWW" %>
...
<table class="DataEntryTable">
                ...
                <tr>
                    ...
                    <td class="NormalTD">
                        ...
                        <asp:CheckBox ID="chk_oldendbit" runat="server" Text="Old Endbits" />
                    </td>
                ...
                <tr>
                    ...
                    <td class="NormalTD" ><asp:Button ID="btn_confirmAtc" runat="server" Text="S" Width="33px" OnClick="btn_confirmAtc_Click" CssClass="auto-style10" /></td>
                    <td class="NormalTD">
                        D O Date:</td>
                    <td  class="NormalTD" >
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="tbl_InverntoryDetails" CssClass="dataentry" ShowFooter="True" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" style="font-size: small; font-family: Calibri; font-weight: 400;" Width="100%" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Endbit_pk">
                                            <ItemTemplate>
                                                <asp:Label ID="lblEndbit_pk" runat="server" Text='<%# Bind("Endbit_pk") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Roll_PK">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRoll_PK" runat="server" Text='<%# Bind("Roll_PK") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="RollNum" HeaderText="RollNum" />
                                        <asp:BoundField DataField="itemDescription" HeaderText="itemDescription" />
                                        <asp:BoundField DataField="WidthGroup" HeaderText="WidthGroup" />
                                        <asp:BoundField DataField="ShadeGroup" HeaderText="ShadeGroup" />
                                        <asp:BoundField DataField="ShrinkageGroup" HeaderText="ShrinkageGroup" />
                                        <asp:BoundField DataField="AYard" HeaderText="AYard" />
                                        <asp:TemplateField HeaderText="SkuDet_PK">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSkuDet_PK" runat="server" Text='<%# Bind("SkuDet_PK") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>                                        
                                        <asp:BoundField DataField="AWidth" HeaderText="AWidth" />
                                        <asp:BoundField DataField="AShrink" HeaderText="AShrink" />
                                         <asp:BoundField DataField="AShade" HeaderText="AShade" />
