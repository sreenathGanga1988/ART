<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="CutplanApproval.aspx.cs" Inherits="ArtWebApp.Production.Cutting.CutplanApproval" %>
    ...
    <div>
        ...
        <tr>
            <td>
                                    ...
                                    <td class="NormalTD">
                                        <ucc:DropDownListChosen ID="drp_rejionreason" runat="server" DataSourceID="rejectiondatasource" DataTextField="CutplanRejection" DataValueField="CutPlanRejectionID" DisableSearchThreshold="10" Width="200px">
                                        </ucc:DropDownListChosen>
                                    </td>
                                    <td class="NormalTD"></td>
                                    <td class="NormalTD"></td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style8" colspan="3">
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                             <asp:Button ID="Button2" runat="server"  Text="Reject Cut Plan " OnClick="Button2_Click" />
                                        </ContentTemplate>
