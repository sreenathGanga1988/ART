...
{
    public partial class CutplanApproval : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cmstrdata.ApproveCutPlan(int.Parse(drp_cutplan.SelectedValue.ToString()));
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            BLL.CutOrderBLL.CutPlanMasterData cmstrdata = new BLL.CutOrderBLL.CutPlanMasterData();
            cmstrdata.Refpattern = txt_refpattern.Text;
            cmstrdata.Rejectionid = int.Parse(drp_rejionreason.SelectedValue.ToString());
            cmstrdata.Rejectionreason = drp_rejionreason.SelectedItem.Text;
            cmstrdata.RejectCutPlan(int.Parse(drp_cutplan.SelectedValue.ToString()));
            string msg = " CutPlan Rejected  And Send to Back to factory";
            ArtWebApp.Controls.Messagebox.MessgeboxUpdate(Messaediv1, "sucess", msg);
        }
    }
}