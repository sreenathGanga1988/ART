<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="CuttingEditor.aspx.cs" Inherits="ArtWebApp.Production.Cutting.CuttingEditor" %>
                                        ...
                                        <ContentTemplate>
                                            <div id="Messaediv1" runat="server">
                                                ...
                                                <table class="auto-style1">
                                                    <tr>
                                                        <td><asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Approve Cut Plan " Enabled="False" /></td>
                                                        <td>
