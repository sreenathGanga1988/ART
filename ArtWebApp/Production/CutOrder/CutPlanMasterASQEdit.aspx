<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="CutPlanMasterASQEdit.aspx.cs" Inherits="ArtWebApp.Production.CutOrder.CutPlanMasterASQEdit" %>
                   ...
                   <table class="DataEntryTable">
                    ...
                    <ContentTemplate>
                            ...
                            <tr>
                                ...
                                <td class="NormalTD">
                                    <asp:UpdatePanel ID="upd_marker" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                ...
                                <td class="SearchButtonTD">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <asp:Button ID="Button1" runat="server" CssClass="auto-style2" OnClick="Button1_Click1" Text="CMN" Visible="False" />
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                                <td class="NormalTD">&nbsp;</td>
