<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="CutPlanMarkerEdit.aspx.cs" Inherits="ArtWebApp.Production.CutOrder.CutPlanMarkerEdit" %>
                        ...
                        <td class="NormalTD" colspan="7" >
                            ...
                            <asp:Panel ID="panel1" runat="server" ViewStateMode="Enabled">
                                <asp:Table ID="Table1" runat="server" ViewStateMode="Enabled" Width="400px">
                                                        ...
                                                        <asp:TemplateField HeaderText="AlreadyAdded">
                                                                
                                                                 <ItemTemplate>
                                                                       <asp:Label ID="lblisAlreadyAdded"   Width ="70px"  Text="N" runat="server"></asp:Label>
                                                                 </ItemTemplate>
                                                             </asp:TemplateField>
