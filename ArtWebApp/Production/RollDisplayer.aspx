<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="RollDisplayer.aspx.cs" Inherits="ArtWebApp.Production.RollDisplayer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="RedHeaddingdIV"> Delivered &nbsp; Rolls</div>
    <div id="MasterDiv"  runat="server">
    
    </div>
    <div class="RedHeaddingdIV"> Pending Roll for Cutting</div>
