...
{
    public partial class QualityInspectionEdit : System.Web.UI.Page
    {
        ...
        protected void btn_fabric_Click1(object sender, EventArgs e)
        {
            ...
            tbl_InverntoryDetails.DataSource = fbrolldet.getRollDetailsofASNforEdit(int.Parse(drp_asn.SelectedValue.ToString()), int.Parse(drp_color.SelectedValue.ToString()));
