...
namespace ArtWebApp.Quality
{
    public partial class InspectionEdit : System.Web.UI.Page
    {
        ...
        protected void btn_fabric_Click1(object sender, EventArgs e)
        {
            ...
            tbl_InverntoryDetails.DataSource = fbrolldet.getRollDetailsofASNandSKUDetPKForEdit(int.Parse(drp_asn.SelectedValue.ToString()), int.Parse(drp_color.SelectedValue.ToString()));
            tbl_InverntoryDetails.DataBind();
            upd_grid.Update();
        }
