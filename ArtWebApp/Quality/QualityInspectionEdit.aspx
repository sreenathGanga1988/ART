<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="QualityInspectionEdit.aspx.cs" Inherits="ArtWebApp.Quality.QualityInspectionEdit" %>
                ...
                <tr>
                    <td  colspan="5" >
                       <table style="border: thin double #C0C0C0; line-height: normal; vertical-align: middle;  text-align: center; white-space: normal; word-spacing: normal; letter-spacing: normal; background-color: #99CCFF; position: relative; width: 100%;" >
                            ...
                            <tr>
                                <td colspan="12" class="DataEntryTable">
         ...
         <asp:GridView ID="tbl_InverntoryDetails" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" style="font-size: small; font-family: Calibri; font-weight: 400;" Width="100%" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4">
                                    ...
                                    <ItemTemplate>
                                     ...
                                     <asp:TemplateField HeaderText="Total Defect" SortExpression="AYard">
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="txt_defect" Width="40px" onkeyup="enter(this)"  Text='<%# Bind("TotalDefect") %>' runat="server" ></asp:TextBox>
                                            </ItemTemplate>
                                          <HeaderStyle Width="40px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Total Defect /100yds" SortExpression="AYard">
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="txt_defectper100"  onkeyup="enter(this)" Text='<%# Bind("TotalDefecton100") %>'  Width="40px" runat="server" ></asp:TextBox>
                                            </ItemTemplate>
                                            <HeaderStyle Width="40px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Total Point" SortExpression="AYard">
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="txt_point" Width="40px" onkeyup="enter(this)" Text='<%# Bind("TotalPoint") %>'  runat="server" ></asp:TextBox>
                                            </ItemTemplate>
                                             <HeaderStyle Width="40px" />
                                        </asp:TemplateField>
                                          <asp:TemplateField HeaderText="Total Point /100yds"  SortExpression="AYard">
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="txt_pointper100" Width="40px" onkeyup="enter(this)"  Text='<%# Bind("TotalPointon100yard") %>' runat="server" ></asp:TextBox>
                                            </ItemTemplate>
                                               <HeaderStyle Width="40px" />
                                        </asp:TemplateField>
