...
{
    public partial class PreQADValidationEntry : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                //  btn_yard.Attributes.Add("OnClientClick", "SetPIN('"+txt_yardage.Text.Trim()+"',7)");

                //    string q = txt_yardage.ClientID;
                //    btn_yard.OnClientClick = "SetPIN(document.getElementById(txt_yardage).value,7)";
                //}
            }
        }
        ...
        protected void btn_yardage_Click1(object sender, EventArgs e)
        {
            updatedatafromsupplier("txt_ayard", "lbl_syard");
        }

        protected void btn_yardage_Click2(object sender, EventArgs e)
        {
