<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="InspectionEdit.aspx.cs" Inherits="ArtWebApp.Quality.InspectionEdit" %>
...
<table class="DataEntryTable">
                <tr>
                    <td class="RedHeadding" colspan="5">
                        pre qad roll VALIDATION(edit)</td>
                </tr>
                <tr>
                            ...
                            <%--<tr>
                              ...
                              <tr>
                                ...
                                <td colspan="2"  class="NormalTD">
                                    <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                        <ContentTemplate>
                                            <asp:Button ID="btn_yardage" Font-Bold="True" Font-Size="X-Small" Text="Copy Supplier Yard" Width="150px" runat="server" Height="22px" OnClientClick="CopyYardage()"  />
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                                <td colspan="2"  class="NormalTD">
                ...
                <tr class="ButtonTR">
                    <td class="NormalTD"  >
                        <asp:Button ID="btn_submitData" runat="server" Text="Update Roll Data" OnClick="btn_submitData_Click" />
                    </td>
                    <td class="NormalTD" >
                        &nbsp;</td>
                    <td class="NormalTD" >
