<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="CuttingTicketEdit.aspx.cs" Inherits="ArtWebApp.Sampling.CuttingTicketEdit" %>
    ...
    <div class="FullTable">
        ...
        <tr>
            <td class="NormalTD">
                Cut Fill</td>
            <td class="NormalTD">
                <ucc:DropDownListChosen  ID="drp_fillcutid" runat="server" AutoPostBack="True" 
                    Height="16px" onselectedindexchanged="drp_fillcutid_SelectedIndexChanged" 
                    Width="147px">
        ...
        <tr>
            <td class="NormalTD">
                ATC No:</td>
            <td class="NormalTD">
                <ucc:DropDownListChosen ID="drp_atcno" runat="server" DataSourceID="SqlDataSource1" 
                    DataTextField="AtcNum" DataValueField="AtcNum" Height="16px" Width="126px">
            ...
            <td class="NormalTD">
                ...
                <ucc:DropDownListChosen  ID="drp_buyer" runat="server" Height="16px" Width="126px" 
                    DataSourceID="SqlDataSource2" DataTextField="BuyerName" 
                    DataValueField="BuyerName">
                </ucc:DropDownListChosen >
            </td>
            <td class="NormalTD">
                </td>
        ...
        <tr>
            <td class="NormalTD">
                Buyer Style</td>
            <td class="NormalTD">
                <ucc:DropDownListChosen  ID="drp_buyerstyle" runat="server" 
                    DataSourceID="SqlDataSource3" DataTextField="BuyerStyle" 
                    DataValueField="BuyerStyle" Height="16px" Width="126px">
                </ucc:DropDownListChosen >
        ...
        <tr>
            <td class="style26" colspan="7">
                <table class="DataEntryTable">
                    ...
                    <tr>
                        <td class="style8">
                              <asp:Button ID="btn_print" runat="server" OnClick="btn_print_Click" Text="Print" /></td>
                        <td colspan="3">
