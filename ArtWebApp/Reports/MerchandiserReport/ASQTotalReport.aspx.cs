...
{
    public partial class ASQTotalReport : System.Web.UI.Page
    {
...
FROM            AtcMaster " + condition;
        ...
        public void fillReportofAtc()
        {
            ...
            if (popaklist.Count > 0 && popaklist != null)
            {
                ...
                String query = @"SELECT        TTT.PoPackId, TTT.OurStyleID, TTT.SeasonName, TTT.BuyerName, TTT.AtcNum, TTT.PoPacknum, TTT.BuyerPO, TTT.OurStyle, TTT.BuyerStyle, TTT.POQty, TTT.ShipedQty, TTT.Balance, TTT.FirstDeliveryDate, 
...
FROM            (SELECT        tt.PoPackId, tt.OurStyleID, tt.SeasonName, BuyerMaster.BuyerName, AtcMaster.AtcNum, tt.PoPacknum, tt.BuyerPO, tt.OurStyle, tt.BuyerStyle, tt.POQty, tt.ShipedQty, tt.POQty - tt.ShipedQty AS Balance,
                          ...
                          FROM            (SELECT        PoPackMaster.PoPackId, PoPackMaster.PoPacknum, PoPackMaster.BuyerPO, AtcDetails.OurStyle, AtcDetails.BuyerStyle, SUM(POPackDetails_1.PoQty) AS POQty, ISNULL
                                                    ...
                                                    FROM            PoPackMaster INNER JOIN
                                                                              ...
                                                                              AtcDetails ON POPackDetails_1.OurStyleID = AtcDetails.OurStyleID  " + conditionatc +
