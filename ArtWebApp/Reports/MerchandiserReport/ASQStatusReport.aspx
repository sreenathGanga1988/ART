<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="ASQStatusReport.aspx.cs" Inherits="ArtWebApp.Reports.MerchandiserReport.ASQStatusReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <table class="FullTable">
            ...
            <tr>
               ...
               <td class="NormalTD">
                ...
                <td class="NormalTD">
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Open  Pending ASQ Report of Selected Atc" />
                </td>
                <td class="SearchButtonTD">&nbsp;</td>
               <td class="NormalTD"></td>
            </tr>
    ...
    <div>
        <asp:SqlDataSource ID="ASQData" runat="server" ConnectionString="<%$ ConnectionStrings:ArtConnectionString %>" SelectCommand="SELECT        tt.PoPackId, tt.OurStyleID, tt.SeasonName, BuyerMaster.BuyerName, AtcMaster.AtcNum, tt.PoPacknum, tt.BuyerPO, tt.OurStyle, tt.BuyerStyle, tt.POQty, tt.ShipedQty, tt.POQty - tt.ShipedQty AS Balance, 
...
FROM            (SELECT        PoPackMaster.PoPackId, PoPackMaster.PoPacknum, PoPackMaster.BuyerPO, AtcDetails.OurStyle, AtcDetails.BuyerStyle, SUM(POPackDetails_1.PoQty) AS POQty, ISNULL
                          ...
                          FROM            PoPackMaster INNER JOIN
                                                    ...
                                                    LocationMaster ON PoPackMaster.ExpectedLocation_PK = LocationMaster.Location_PK
            ...
            <ig:WebDataGrid ID="WebDataGrid1" runat="server" AutoGenerateColumns="False" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" CellSpacing="1" ClientIDMode="Static" DataMember="DefaultView" DefaultColumnWidth="120px" Font-Bold="True" ForeColor="#000099" HeaderCaptionCssClass="headerclass" Height="100%" ItemCssClass="rowcell" DataSourceID="ASQData">
                <Columns>
                    ...
                    <ig:BoundDataField DataFieldName="FirstDeliveryDate" Key="FirstDeliveryDate">
                        <Header Text="First Delivery Date">
                        </Header>
                    </ig:BoundDataField>
