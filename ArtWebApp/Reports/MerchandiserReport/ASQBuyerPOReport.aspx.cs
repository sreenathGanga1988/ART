...
{
    public partial class ASQBuyerPOReport : System.Web.UI.Page
    {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    try
                    {
                        ...
                        DataTable sizedata = BLL.FactoryAtcChart.createdatatablebuyerpo(dt, popackid, ourstyleid);
        ...
        public void showAsqDataofselectedPO()
        {
            ...
            if (popaklist.Count > 0 && popaklist != null)
            {
                ...
                DataTable sizedata = BLL.FactoryAtcChart.createdatatablebuyerpo(newresult);
        ...
        protected void btn_showallasq_Click(object sender, EventArgs e)
        {
            ...
            DataTable sizedata = BLL.FactoryAtcChart.createdatatablebuyerpo(dt);
