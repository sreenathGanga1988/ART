...
{
    public partial class OrderOnhandReportofyearfactorywise : System.Web.UI.Page
    {
        ...
        public void loaDYearlyShippedReport()
        {
            ...
            System.Data.DataTable dt = DBTransaction.Productiontransaction.SchedularReportTransaction.OrderonHandofyearFactorywise(year);
            ...
            this.ReportViewer1.LocalReport.ReportPath = @"Reports\RDLC\OrderOnHand FactoryWise.rdlc";
