<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Stylecostingprintable.aspx.cs" Inherits="ArtWebApp.Reports.StyleCostingprintable" %>
...
<body>
    ...
    <div class="auto-style1">
                            ...
                            <table class="auto-style2">
                                <tr>
                                    ...
                                    <td>
                                        <table class="auto-style2">
                                            <tr class="auto-style17">
                                                <td class="auto-style31">2<strong>nd LAST COST</strong></td>
                                            </tr>
                                            <tr class="auto-style17">
                                    ...
                                    <td>
                                        <table class="auto-style2">
                                            <tr class="auto-style17">
                                                <td class="auto-style32"><strong>3rd LAST COST</strong></td>
                                            </tr>
                                            <tr class="auto-style17">
        ...
        <tr>
            <td class="auto-style33" colspan="3"><strong>TRIMS COST DETAILS</td>
                    </tr>
        <tr>
            <td style="font-size: small; font-family: Calibri" class="auto-style37" colspan="3">
                            <asp:GridView ID="tbl_trmdet" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" Width="600px" ForeColor="Black" GridLines="Vertical" AutoGenerateColumns="False">
                                ...
                                <HeaderStyle BackColor="#6B696B" Font-Bold="True" ForeColor="White" />
                                <PagerStyle BackColor="#F7F7DE" ForeColor="Black" HorizontalAlign="Right" />
                                <RowStyle BackColor="#F7F7DE" BorderColor="#666666" BorderWidth="0px" />
                                <SelectedRowStyle BackColor="#CE5D5A" Font-Bold="True" ForeColor="White" />
                                <SortedAscendingCellStyle BackColor="#FBFBF2" />
                                <SortedAscendingHeaderStyle BackColor="#848384" />
                                <SortedDescendingCellStyle BackColor="#EAEAD3" />
