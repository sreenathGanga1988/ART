...
namespace ArtWebApp.Merchandiser
{
    public partial class MerchandisingDashBoard : System.Web.UI.Page
    {
        ...
        private DataTable GetPOData()
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand(@"SELECT        ProcurementMaster.PO_Pk, ProcurementMaster.PONum, AtcMaster.AtcNum, SupplierMaster.SupplierName, CurrencyMaster.CurrencyCode, SUM(ProcurementDetails.POQty * ProcurementDetails.POUnitRate) 
...
HAVING        (ProcurementMaster.IsApproved = N'N') AND (ProcurementMaster.IsDeleted <> N'Y')"))
