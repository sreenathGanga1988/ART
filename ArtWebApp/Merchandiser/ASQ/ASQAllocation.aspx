<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="ASQAllocation.aspx.cs" Inherits="ArtWebApp.Merchandiser.ASQ.ASQAllocation" %>
                                                    ...
                                                    <ItemTemplate>
                                                        <table class="tittlebar">
                                                            ...
                                                            <tr>
                                                             ...
                                                             <tr>
                                                                <td>factid</td>
                                                                <td>  <asp:Label ID="lbl_recfactid" runat="server" Text='<%# Bind("ExpectedLocation_PK") %>'></asp:Label></td>
                                                            </tr>
