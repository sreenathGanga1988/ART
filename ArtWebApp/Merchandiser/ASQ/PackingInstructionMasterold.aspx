...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
   ...
   <script src="../../JQuery/GridJQuery.js"></script>
    <script type="text/javascript">
        ...
        { debugger;
            ...
            //Assc Color Solid Size
            var e = document.getElementById("<%= drp_type.ClientID %>");
            var strUser = e.options[e.selectedIndex].text;

            if (strUser == "Ass Color Ass Size")
            {
                Calculateassc();
            }
            else if (strUser == "Solid Color Assc Size")
            {
   ...
   //function for assorted
    function Calculateassc()
       {
            ...
            <td class="DataEntryTable">
               ...
               <ucc:DropDownListChosen ID="cmb_atc" runat="server" DataSourceID="atcdatasource" DataTextField="AtcNum" DataValueField="AtcId" DisableSearchThreshold="10" Width="200px" OnSelectedIndexChanged="cmb_atc_SelectedIndexChanged">
                            ...
                            <tr>
                                ...
                                <td class="SearchButtonTD">
                                    <asp:Button ID="buttonAtc0" runat="server" Height="26px" OnClick="buttonAtc0_Click" Text="S" />
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
