<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="LoanPO.aspx.cs" Inherits="ArtWebApp.Merchandiser.PO.LoanPO" %>
                ...
                <asp:UpdatePanel ID="Upd_Main" UpdateMode="Conditional"  ChildrenAsTriggers="false" runat="server">
                    <ContentTemplate>
                        <table class="DataEntryTable">
                            <tr>
                                <td class="RedHeadding" colspan="7">loan<strong> P.O.</strong></td>
                            </tr>
                            <tr>
                                <td >Supplier</td>
                                <td >
                                ...
                                <ContentTemplate>
                                                  <ucc:DropDownListChosen ID="drp_supplier" runat="server" AutoPostBack="true" DataSourceID="supplierdata" DataTextField="SupplierName"
                                                      DataValueField="Supplier_PK" DisableSearchThreshold="10" Width="200px"  >
