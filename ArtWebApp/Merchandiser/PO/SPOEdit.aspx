<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="SPOEdit.aspx.cs" Inherits="ArtWebApp.Merchandiser.PO.SPOEdit" %>
                        ...
                        <td>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
                                <ContentTemplate>
                                    <table>
                                        <tr>
                                            <td class="RedHeadding" colspan="7">general<strong> P.O.</strong></td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Button ID="Button3" runat="server" Font-Size="Smaller" OnClick="Button3_Click" Text="S" />
                                            </td>
                                            <td aria-invalid="grammar">&nbsp;</td>
                                            <td>&nbsp;</td>
                                            <td rowspan="6">REMARK</td>
                                            <td rowspan="6">
                                                <textarea id="txt_remark"   runat="server"   class ="auto-style8" name="S1"></textarea></td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                ...
                                <ContentTemplate>
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp;</td>
                                            <td>
                                                <asp:Button ID="btn_AddSpo" runat="server" OnClick="btn_AddSpo_Click" Text="Update" />
                                            </td>
                                            <td>
                                                &nbsp;</td>
                                        </tr>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td class="NormalTD">
                                                ...
                                                <ucc:DropDownListChosen ID="cmb_itemgroup" Width="200px" DataSourceID="itemgroup" DataTextField="ItemGroupName" DataValueField="ItemGroupID" runat="server">
                                             </ucc:DropDownListChosen>
                                            </td>
                                            <td class="aNormalTD">
                                            ...
                                            <td class="NormalTD">
                                                <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        ...
                                                        <ucc:DropDownListChosen ID="drp_templateforComp" Width="170px" runat="server">
                                             </ucc:DropDownListChosen>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </td>
                                            ...
                                            <td class="NormalTD">
                                                <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                          ...
                                                          <ucc:DropDownListChosen ID="drp_composition" Width="170px" runat="server">
                                             </ucc:DropDownListChosen>
                                        ...
                                        <tr>
                                            <td class="NormalTD" colspan="8"><</td>
                                        </tr>
                                    </table>
