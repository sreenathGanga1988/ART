...
{
    public partial class SPOEdit : System.Web.UI.Page
    {
        ...
        protected void tbl_spodetails_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            int index = Convert.ToInt32(e.CommandArgument);
            GridViewRow row = tbl_spodetails.Rows[index];
        ...
        protected void drp_paymentterm_SelectedIndexChanged(object sender, EventArgs e)
        {
